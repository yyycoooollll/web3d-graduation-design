...
const DissolveMap = forwardRef(({ scale = 1, position = [0, 0, 0], onDissolveComplete, ...props }, ref) => {
    ...
    const handleClick = () => {
        ...
        gsap.to(dissolveObj, {
            ...
            onComplete() {
                // 溶解完成后切到 ai_effect，并通知主页面切换 DOM 特效层
                setSceneState('ai_effect')
                if (typeof onDissolveComplete === 'function') {
                    onDissolveComplete()
                }
            },
        })
